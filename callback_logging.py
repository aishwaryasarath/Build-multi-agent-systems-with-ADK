    ...
    if llm_response.content and llm_response.content.parts:
        for part in llm_response.content.parts:
            if part.text:
                ...
                logging.info(f"[function call from {callback_context.agent_name}]: " + part.function_call.name)student_03_3ada2949dd26@cloudshell:~/adk_multiagent_systems (qwiklabs-
